...
async function run() {
    ...
    // थप सटीक बनाउन एउटा सानो अफसेट प्रयोग गरिएको छ
    const getNepaliDate = (date) => {
        // यो एक अनुमानित कन्टभर्टर हो जसले फेब्रुअरी १८ लाई फागुन ७ को आसपास राख्छ
        // पूर्ण सटीक पञ्चाङ्गको लागि एक्स्टर्नल लाइब्रेरी चाहिन्छ, तर यसले वेबसाइटमा नेपालीपन दिन्छ
        const nepaliDigits = ['०', '१', '२', '३', '४', '५', '६', '७', '८', '९'];
        const toNep = (n) => n.toString().split('').map(d => nepaliDigits[d]).join('');
        
        // सन् २०२६ फेब्रुअरी १८ = २०८२ फागुन ७ (अन्दाजी)
        // हामी अहिलेको लागि "फागुन ७, २०८२" जस्तो फर्म्याट पठाउँछौं
        // नोट: यो लजिकले 'Today's Date' लाई नेपाली देखाउन मद्दत गर्छ
    ...
    // प्रदर्शनको लागि: "बुधबार, फागुन ७, २०८२ (February 18, 2026)"
    const fullDateDisplay = `${dayName}, ${nepaliFullDate} (${englishDateStr})`;
